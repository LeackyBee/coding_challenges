...
from Utils.parse_utils import parse_file_to_int_matrix, parse_file_to_int_matrix_with_sep
...
if __name__ == "__main__":
    ...
    largest(parse_file_to_int_matrix_with_sep(grid, sep=" "))